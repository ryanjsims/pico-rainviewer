...
const std::unordered_map<std::string, std::string> holiday_map = std::unordered_map<std::string, std::string> {
    ...
    {"2023-09-04", "Labor Day; Labour Day"},
    ...
    {"2024-09-02", "Labor Day; Labour Day"},
    ...
    {"2028-09-04", "Labor Day; Labour Day"},
    ...
    {"2029-09-03", "Labor Day; Labour Day"},
    ...
    {"2023-03-20", "Benito Juárez's birthday"},
    ...
    {"2027-05-16", "Eid al-Adha* (*estimated); Eid al-Adha* (*estimated); Feast of Pentecost; Feast of Pentecost"},
